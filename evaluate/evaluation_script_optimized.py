...
def calculateExactTripleScore(reflist, candlist):
    newreflist = [sorted([string.lower() for string in sublist]) for sublist in reflist]
    newcandlist = [sorted([string.lower() for string in sublist]) for sublist in candlist]
